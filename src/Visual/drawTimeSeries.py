...
class TimeSeriesPlot:
    ...
    def paint(self):
        ...
        self.ax.plot(x_data, y_data, label="Total Connection Count", color="black", linewidth=1)
        self.decoration()
    ...
    def decoration(self):
        ...
        # self.ax.set_yticks(list(range(0, max_y_lim+1, 50000)))
        # self.ax.set_yticklabels(["0"] + ["$%0.1fx10^{5}$" % base for base in np.arange(0.5, 28, 0.5)])
...
if __name__ == '__main__':
    ...
    totalmodule_list = ["inothers", "inakamai"]
