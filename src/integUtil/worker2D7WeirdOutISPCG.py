"""
" Similar script with worker2D2, but the Outer Server is classified based on the ISP they belong to.
        ...
        if dataDict[key]["weird"]:
            ...
            try:
                if srcIP.startswith("136.159."):
                    ...
                    weirdOutCollect[IPDB[dstIP]["isp"]] += 1
                else:
                    weirdOutCollect[IPDB[srcIP]["isp"]] += 1
            except KeyError:
